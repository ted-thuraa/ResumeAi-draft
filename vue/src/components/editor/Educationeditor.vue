    ...
    <div class="is-dropdown">
      <div class="is-dropdown_header_sect">
        <div class="is-dropdown_header-inner">
          ...
          <span>{{ model.startschool_date }} - {{ model.endschool_date }}</span>
        </div>
      ...
      >
        <div class="is-block">
          <div class="form-item">
            <label for="Jobtitle" className="name-field">School name</label>
            <input
              type="text"
              name="jobtitle"
              id="jobtitle"
          ...
          <div class="form-item is-flex_row">
            <div class="flexxed">
              ...
              <input
                ...
                name="startdate"
                id="Startdate"
                v-model="model.startschool_date"
                @change="dataChange"
        ...
        <div class="texteditor-wrapper">
          <RichTextEditor
            v-model="model.school_description"
            @change="dataChange"
          />
        </div>
      </div>
...
const emit = defineEmits(["change", "addEducation", "deleteEducation"]);

//re-create the whole experience data to avoid unintentional reference change
const model = ref(JSON.parse(JSON.stringify(props.education)));
...
function addEducation() {
  emit("addEducation", props.index + 1);
}

function deleteEducation() {
  emit("deleteEducation", props.education);
}
